...
public final class ScanResult {
    ...
    @NotNull private final Set<Class<?>> components;

    /** Classes annotated with {@link Command}. */
    @NotNull private final Set<Class<?>> commands;

    /** Classes annotated with {@link Config}. */
    @NotNull private final Set<Class<?>> configs;

    /** Classes annotated with {@link dev.mzcy.core.annotation.Listener}. */
    @NotNull private final Set<Class<?>> listeners;

    /** Classes annotated with {@link DataStore}. */
    @NotNull private final Set<Class<?>> dataStores;

    /** Classes annotated with {@link InventoryGui}. */
    @NotNull private final Set<Class<?>> inventoryGuis;
    ...
    public static final class Builder {
        ...
        public Builder component(Class<?> cls)    { components.add(cls);    return this; }
        public Builder command(Class<?> cls)      { commands.add(cls);      return this; }
        public Builder config(Class<?> cls)       { configs.add(cls);       return this; }
        public Builder listener(Class<?> cls)     { listeners.add(cls);     return this; }
        public Builder dataStore(Class<?> cls)    { dataStores.add(cls);    return this; }
        public Builder inventoryGui(Class<?> cls) { inventoryGuis.add(cls); return this; }
